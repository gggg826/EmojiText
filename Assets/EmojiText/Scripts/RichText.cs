...
public class RichText : Text 
{
    ...
    {
        m_EmojiIndexDict = new Dictionary<string, EmojiSampleInfo>();
    ...
    {
        float heighOffset = fontSize * 0.06f;
        ...
        {
            m_TempVerts[3].uv1 = new Vector2(emoji.x, emoji.y);
            m_TempVerts[2].uv1 = new Vector2(emoji.x + emoji.size, emoji.y);
            m_TempVerts[1].uv1 = new Vector2(emoji.x + emoji.size, emoji.y + emoji.size);
            m_TempVerts[0].uv1 = new Vector2(emoji.x, emoji.y + emoji.size);
        }
        else
        {
